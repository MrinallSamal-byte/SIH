    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-xs dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-1 text-2xl font-bold font-mono text-slate-900 dark:text-white">{allActions.length}</div>
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xs dark:border-slate-800 dark:bg-slate-900">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="border-b border-slate-200 bg-slate-50 text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:border-slate-800 dark:bg-slate-950 dark:text-white mono">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {filtered.map((l) => (
                <tr key={l.id} className="transition hover:bg-slate-50/70 dark:hover:bg-slate-800/50">
                  <td className="px-5 py-3.5 font-medium text-slate-900 dark:text-white font-mono">
                    <div className="flex items-center gap-2">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-white">
                  ...
                  <td className="px-5 py-3.5 text-slate-700 dark:text-white">
                  ...
                  <td className="px-5 py-3.5 text-slate-500 dark:text-white font-mono">
        ...
        {filtered.length === 0 && (
          <div className="p-12 text-center text-xs text-slate-400 dark:text-white">
