...
export default function Agencies() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold">Multi-agency response roster</h1>
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">NDRF, fire, police, hospitals, and NGOs with jurisdiction.</p>
