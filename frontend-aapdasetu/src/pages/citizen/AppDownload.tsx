    ...
    <div className="mx-auto max-w-5xl space-y-14 pb-12">
      ...
      <section className="grid items-center gap-8 pt-4 md:grid-cols-2 md:gap-10">
        <div className="space-y-4">
          {/* App Logo — branding for download page (uses frontend-aapdasetu/public/logo.png via AapdaSetuLogo + fallback img) */}
          <div className="flex items-center gap-3">
            <AapdaSetuLogo size={48} />
            <div className="flex flex-col">
              <span className="text-lg font-black tracking-tight leading-none text-zinc-900 dark:text-white">AapdaSetu</span>
              <span className="text-[10px] font-bold tracking-widest text-zinc-500 dark:text-white mono uppercase">SOA MESH · ICS NETWORK</span>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-zinc-200/80 bg-zinc-100/90 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-zinc-700 dark:border-white/[0.08] dark:bg-white/[0.05] dark:text-white">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-zinc-800 dark:text-white sm:text-3xl md:text-4xl">
            {t('appdl.heroTitle')}
          </h1>

          <p className="text-sm leading-relaxed text-zinc-500 dark:text-white sm:text-base">
            {t('appdl.heroDesc')}
          </p>

          {/* Version chip */}
          <div className="inline-block rounded-full border border-zinc-200/80 bg-white px-3 py-1 font-mono text-[11px] font-bold text-slate-500 dark:border-white/[0.08] dark:bg-[#1a1a1a] dark:text-white">
            {t('appdl.versionChip')}
          </div>
          ...
          <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center">
            {apkMissing ? (
              <button
                ...
                disabled
                aria-disabled="true"
                className="inline-flex cursor-not-allowed items-center justify-center gap-2.5 rounded-xl bg-zinc-300 px-7 py-4 text-base font-extrabold text-zinc-500 shadow-sm dark:bg-[#252525] dark:text-white"
              >
            ...
            {apkMissing && (
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-6 py-3.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50 active:scale-[0.98] dark:border-white/[0.1] dark:bg-[#1a1a1a] dark:text-white dark:hover:bg-[#252525]"
              >
            ...
            {apkState === 'ready' && (
              <>
                ...
                <a
                  ...
                  className="underline decoration-dotted underline-offset-2 hover:text-slate-600 dark:hover:text-white"
                >
        ...
        <div className="mx-auto w-full max-w-[260px]">
          ...
          <p className="mt-3 text-center text-xs leading-relaxed text-slate-400 dark:text-white">
            {t('appdl.meshCaption')}
          </p>
        </div>
      </section>
      ...
      <section className="space-y-5">
        <div className="flex flex-col justify-between gap-1 sm:flex-row sm:items-end">
          <div>
            <h2 className="text-xl font-bold tracking-tight text-zinc-800 dark:text-white sm:text-2xl">
              {t('appdl.metricsTitle')}
            </h2>
            <p className="mt-1 text-xs text-zinc-500 dark:text-white sm:text-sm">
              {t('appdl.metricsSubtitle')}
            </p>
          </div>
          <div className="inline-flex items-center gap-1.5 font-mono text-[11px] font-semibold text-zinc-500 dark:text-white">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-100 text-zinc-800 dark:bg-white/[0.06] dark:text-white">
                    <Icon className="h-5 w-5" />
                  </div>
                </div>
                <h3 className="mt-3 text-xs font-bold uppercase tracking-wider text-zinc-700 dark:text-white">
                  {t(metric.labelKey)}
                </h3>
      ...
      <section className="space-y-5">
          ...
          {whyCards.map((card) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mb-1.5 text-sm font-bold text-zinc-800 dark:text-white">
                  {t(card.titleKey)}
                </h3>
                <p className="text-xs leading-relaxed text-zinc-500 dark:text-white">
                  {t(card.descKey)}
                </p>
              </div>
            )
        ...
        <p className="text-xs leading-relaxed text-slate-400 dark:text-white">
          {t('appdl.meshNote')}
        </p>
      </section>
      ...
      <section className="space-y-5">
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 pt-1.5">
                  ...
                  <span className="text-sm font-medium leading-relaxed text-zinc-600 dark:text-white">
                    {t(item.textKey)}
                  </span>
                </div>
              </li>
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50/70 p-5 shadow-sm dark:border-amber-900/40 dark:bg-amber-950/20">
      ...
      <section className="space-y-5">
        <div>
          <div className="flex items-center gap-2">
            <Quote className="h-5 w-5 text-zinc-500 dark:text-white" />
            <h2 className="text-xl font-bold tracking-tight text-zinc-800 dark:text-white sm:text-2xl">
              {t('appdl.reviewsTitle')}
            </h2>
          </div>
          <p className="mt-1 text-xs leading-relaxed text-zinc-500 dark:text-white sm:text-sm">
              ...
              <div>
                <div className="mb-3.5 flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-zinc-200 bg-zinc-100 text-zinc-700 dark:border-white/[0.1] dark:bg-white/[0.06] dark:text-white">
                      <Shield className="h-4 w-4" />
                    </div>
                    <div className="min-w-0">
                      <h3 className="truncate font-mono text-xs font-bold text-zinc-800 dark:text-white">
                        {t(review.authorKey)}
                      </h3>
                      <span className="block truncate text-[11px] text-zinc-400 dark:text-white">
                        {t(review.contextKey)}
                      </span>
                    </div>
                  </div>
                  <span className="shrink-0 rounded-md border border-zinc-200 bg-zinc-50 px-2 py-0.5 font-mono text-[10px] font-semibold text-zinc-600 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white">
                    {t(review.tagKey)}
                  </span>
                </div>

                <blockquote className="text-xs leading-relaxed text-zinc-600 dark:text-white sm:text-sm">
                  “{t(review.quoteKey)}”
                </blockquote>
              </div>

              <div className="mt-4 flex items-center justify-between border-t border-zinc-100 pt-3 dark:border-white/[0.05]">
                <span className="font-mono text-[11px] font-medium text-zinc-400 dark:text-white">
                  {review.metric}
                </span>
      ...
      <section className="space-y-5">
        ...
        <div className="space-y-3">
          {faqItems.map((item) => (
            ...
            >
              <summary className="cursor-pointer list-none text-sm font-bold text-zinc-800 marker:hidden marker:content-none dark:text-white [&::-webkit-details-marker]:hidden">
                <span className="mr-2 inline-block text-red-500 transition-transform group-open:rotate-90">▸</span>
                {t(item.qKey)}
              </summary>
              <p className="mt-2.5 pl-6 text-xs leading-relaxed text-zinc-500 dark:text-white">
                {t(item.aKey)}
              </p>
            </details>
          ))}
