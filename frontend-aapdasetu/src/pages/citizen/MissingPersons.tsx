    ...
    <div className="mx-auto max-w-3xl">
      ...
      {tab === 'registry' && (
        <div className="mt-4 space-y-4">
          <div className="flex flex-col gap-3 rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-xs sm:flex-row sm:items-center dark:border-white/[0.08] dark:bg-[#1a1a1a]">
      ...
      <div>
        ...
        <div className="flex items-center gap-3">
          {photoDataUrl ? (
            ...
            <div className="flex h-16 w-16 items-center justify-center rounded-xl border border-dashed border-zinc-200 bg-[#f4f4f5] text-slate-400 dark:border-white/[0.1] dark:bg-[#222222]">
