            ...
            <div className="mt-6 w-full max-w-3xl space-y-5 rounded-2xl border border-red-200 bg-white p-6 text-left shadow-sm dark:border-red-900/50 dark:bg-[#1a1a1a]">
              ...
              <div className="border-t border-zinc-200/80 pt-4 dark:border-white/[0.08]">
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-2 text-center text-xs font-bold">
                  <a href="tel:112" className="rounded-xl bg-[#f4f4f5] p-2 sm:p-2.5 text-zinc-700 transition hover:bg-zinc-200 dark:bg-[#222222] dark:text-slate-200">
                    <div className="text-sm sm:text-base font-bold text-red-600 mono">112</div>
                    <div className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 break-words leading-tight mt-0.5">{t('helpline.nationalSos')}</div>
                  </a>
                  <a href="tel:108" className="rounded-xl bg-[#f4f4f5] p-2 sm:p-2.5 text-zinc-700 transition hover:bg-zinc-200 dark:bg-[#222222] dark:text-slate-200">
                    <div className="text-sm sm:text-base font-bold text-amber-600 mono">108</div>
                    <div className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 break-words leading-tight mt-0.5">{t('helpline.ambulance')}</div>
                  </a>
                  <a href="tel:1070" className="rounded-xl bg-[#f4f4f5] p-2 sm:p-2.5 text-zinc-700 transition hover:bg-zinc-200 dark:bg-[#222222] dark:text-slate-200">
                    <div className="text-sm sm:text-base font-bold text-emerald-600 mono">1070</div>
                    <div className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 break-words leading-tight mt-0.5">{t('helpline.disaster')}</div>
                  </a>
                </div>
              </div>
            </div>
