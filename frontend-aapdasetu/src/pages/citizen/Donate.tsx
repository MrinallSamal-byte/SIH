    ...
    return (
      <div className="mx-auto w-full max-w-2xl pb-12">
        <div className="rounded-2xl border border-emerald-200 bg-white p-6 text-center shadow-sm dark:border-emerald-900/50 dark:bg-[#1a1a1a] sm:p-8">
          ...
          <p className="mono mt-3 text-[11px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-300">
            {t('donate.successBadge', 'Donation recorded · Demo')}
          </p>
          <h1 className="mt-2 text-2xl font-bold tracking-tight text-zinc-900 dark:text-slate-100">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-200/80 bg-[#f4f4f5] p-5 text-left dark:border-white/[0.08] dark:bg-[#151515]">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <span className="mono text-[10px] font-bold uppercase tracking-wider text-slate-400">
                  {t('donate.receiptId', 'Receipt ID')}
                </span>
                <div className="mono mt-1 break-all text-xl font-bold text-zinc-900 dark:text-slate-100">{success.receiptId}</div>
              </div>
              <button
                type="button"
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <div className="text-lg font-bold text-zinc-900 dark:text-slate-100">{formatINR(success.amount)}</div>
              </div>
              <div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">
                  {t('donate.fund', 'Fund')}
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            ...
            <button
              ...
              className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white py-3 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-200"
            >
          ...
          <Link
            to="/track"
            className="mt-4 inline-block text-xs font-semibold text-slate-500 underline underline-offset-2 hover:text-zinc-800 dark:text-slate-400"
          >
  ...
  return (
    <div className="mx-auto w-full max-w-6xl pb-12">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-slate-100 sm:text-2xl">
      ...
      <div className="mt-4 flex items-start gap-2.5 rounded-2xl border border-amber-300/80 bg-amber-50 p-4 text-xs leading-relaxed text-amber-900 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-200">
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            <h2 className="mono text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="rounded-full border border-zinc-200 bg-white px-2 py-0.5 text-[10px] font-bold text-zinc-600 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-300">
                        {f.tagFallback}
                      </span>
                    </div>
                    <div className="mt-2.5 text-sm font-bold text-zinc-900 dark:text-slate-100">{t(f.nameKey, f.nameFallback)}</div>
                    <div className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">{f.orgFallback}</div>
                    {active && (
                      <div className="mt-2 inline-flex items-center gap-1 text-xs font-bold text-emerald-700 dark:text-emerald-300">
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className={`rounded-xl border px-4 py-2.5 text-sm font-bold transition active:scale-95 ${
                      active
                        ...
                        : 'border-zinc-200 bg-white text-zinc-700 hover:border-zinc-400 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-200'
                    }`}
                  >
              ...
              <button
                ...
                className={`rounded-xl border px-4 py-2.5 text-sm font-bold transition active:scale-95 ${
                  customSelected
                    ? 'border-emerald-600 bg-emerald-600 text-white'
                    : 'border-dashed border-zinc-300 bg-white text-zinc-600 hover:border-zinc-500 dark:border-zinc-600 dark:bg-[#222] dark:text-slate-300'
                }`}
              >
            ...
            {customSelected && (
              <div className="mt-3">
                <label htmlFor="donate-amount" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="500"
                    inputMode="numeric"
                    className="w-full rounded-xl border border-zinc-200 py-2.5 pl-8 pr-3.5 text-sm font-bold outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                  />
                </div>
              </div>
            )}
            <p className="mt-2 text-xs font-semibold text-zinc-700 dark:text-slate-300">
              {t('donate.youGive', 'You give:')} <span className="mono text-base font-bold">{formatINR(Number.isFinite(parsedAmount) ? parsedAmount : 0)}</span>
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div>
                <label htmlFor="donate-name" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                ...
                <input
                  ...
                  autoComplete="name"
                  disabled={anonymous}
                  className="w-full rounded-xl border border-zinc-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 disabled:opacity-50 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                />
              </div>
              <div>
                <label htmlFor="donate-phone" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                ...
                <input
                  ...
                  type="tel"
                  autoComplete="tel"
                  className="mono w-full rounded-xl border border-zinc-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                />
              </div>
            </div>
            <div className="mt-3">
              <label htmlFor="donate-pan" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
              ...
              <input
                ...
                className="mono w-full rounded-xl border border-zinc-200 px-3.5 py-2.5 text-sm uppercase outline-none transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-200 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100 sm:max-w-xs"
              />
            </div>
            <label className="mt-3 flex cursor-pointer items-center gap-2.5 text-sm font-medium text-zinc-700 dark:text-slate-300">
              <input
                type="checkbox"
                checked={anonymous}
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            {method === 'upi' && (
              <div className="mt-3 rounded-xl bg-[#f4f4f5] p-3.5 text-xs dark:bg-[#151515]">
                <div className="flex items-center justify-between gap-2">
                  <span className="min-w-0 break-all font-bold text-zinc-700 dark:text-slate-200">
                    {t('donate.fundUpi', 'Fund UPI handle:')} <span className="mono">{fund.upiFallback}</span>
                  </span>
                  <button
                    type="button"
                    onClick={() => copyText(fund.upiFallback)}
                    className="inline-flex shrink-0 items-center gap-1 rounded-lg bg-zinc-800 px-2 py-1 text-[11px] font-bold text-white hover:bg-zinc-700 dark:bg-slate-100 dark:text-zinc-800"
                  >
                    <Copy className="h-3 w-3" />
                    <span>{copied ? t('common.copied', 'Copied!') : t('common.copy', 'Copy')}</span>
                  </button>
                </div>
                <label htmlFor="donate-upi" className="mb-1 mt-3 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                ...
                <input
                  ...
                  autoComplete="off"
                  className="mono w-full rounded-xl border border-zinc-200 bg-white px-3.5 py-2.5 text-sm outline-none transition focus:border-emerald-600 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                />
              </div>
            )}
            ...
            {method === 'card' && (
              <div className="mt-3 grid gap-2.5">
                <div>
                  <label htmlFor="donate-card" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                  ...
                  <input
                    ...
                    className="mono w-full rounded-xl border border-zinc-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-emerald-600 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2.5">
                  <div>
                    <label htmlFor="donate-exp" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                  ...
                  <div>
                    <label htmlFor="donate-cvv" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                      CVV
                    </label>
                    <input
                      id="donate-cvv"
            ...
            {method === 'netbanking' && (
              <div className="mt-3">
                <label htmlFor="donate-bank" className="mb-1 block text-xs font-bold text-zinc-600 dark:text-slate-300">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2.5 text-sm outline-none focus:border-emerald-600 dark:border-white/[0.1] dark:bg-[#222] dark:text-slate-100"
                >
        ...
        <div className="space-y-4">
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            <ul className="mt-3 space-y-2.5 text-xs leading-relaxed text-zinc-600 dark:text-slate-300">
            ...
            <div className="mt-3 rounded-xl bg-[#f4f4f5] p-3 text-[11px] leading-relaxed text-slate-500 dark:bg-[#151515] dark:text-slate-400">
              {t(
                'donate.fraudNote',
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            <ul className="mt-3 space-y-2.5">
              {feed.map((d) => (
                ...
                >
                  <div className="min-w-0">
                    <div className="truncate font-bold text-zinc-800 dark:text-slate-200">
          ...
          <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <a
                ...
                className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-zinc-200 py-2.5 text-xs font-bold text-zinc-700 transition hover:bg-zinc-50 dark:border-white/[0.1] dark:text-slate-200 dark:hover:bg-[#222]"
              >
