    ...
    <div className="space-y-6">
      ...
      {volunteer && (
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 sm:p-6 shadow-xs dark:border-white/[0.08] dark:bg-[#1a1a1a]">
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-zinc-200/80 bg-white p-4 sm:p-6 shadow-xs dark:border-white/[0.08] dark:bg-[#1a1a1a]">
            <div>
