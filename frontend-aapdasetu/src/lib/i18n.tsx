...
const dictionaries: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sos.namePlaceholder': 'Optional — your full name',
    'sos.phone': 'Mobile number (optional)',
    'sos.phonePlaceholder': 'Optional — 10-digit mobile number',
  ...
  hi: {
    ...
    'sos.namePlaceholder': 'वैकल्पिक — आपका पूरा नाम',
    'sos.phone': 'मोबाइल नंबर (वैकल्पिक)',
    'sos.phonePlaceholder': 'वैकल्पिक — 10 अंकों का मोबाइल नंबर',
  ...
  or: {
    ...
    'sos.namePlaceholder': 'ବିକଳ୍ପ — ଆପଣଙ୍କ ପୂରା ନାମ',
    'sos.phone': 'ମୋବାଇଲ ନମ୍ବର (ବିକଳ୍ପ)',
    'sos.phonePlaceholder': 'ବିକଳ୍ପ — 10 ଅଙ୍କ ମୋବାଇଲ ନମ୍ବର',
