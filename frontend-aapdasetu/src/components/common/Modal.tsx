...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs" onClick={onClose}>
      <div
        className="max-h-[88vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-zinc-200/80 bg-white p-4 sm:p-6 shadow-xl dark:border-white/[0.08] dark:bg-[#1a1a1a]"
