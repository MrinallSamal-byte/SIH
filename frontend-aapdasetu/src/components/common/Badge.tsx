...
const colors: Record<string, string> = {
  info: 'bg-slate-100 text-slate-800 border border-slate-200 dark:border-white/[0.1] dark:bg-slate-800 dark:text-white',
  ...
  closed: 'bg-slate-100 text-slate-600 border border-slate-200 dark:border-slate-800 dark:bg-slate-800 dark:text-white',
  ...
  pending: 'bg-slate-100 text-slate-700 border border-slate-200 dark:border-slate-800 dark:bg-slate-800 dark:text-white',
  ...
  return (
    <span
      className={`inline-flex items-center rounded-md px-2 py-0.5 text-[11px] font-semibold tracking-wide ${
        colors[key] ?? 'bg-slate-100 text-slate-700 border border-slate-200 dark:border-slate-800 dark:bg-slate-800 dark:text-white'
      }`}
    >
      {text}
    </span>
