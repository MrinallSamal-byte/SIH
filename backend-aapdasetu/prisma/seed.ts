...
async function main() {
  ...
  if ((await prisma.missingPerson.count()) === 0) {
      ...
      data: [
        {
          ...
          age: 9,
          gender: 'female',
          lastSeenLocation: 'Old Town Market, Bhubaneswar',
          clothes: 'Red dress',
          contactPhone: '+91-9000000301',
          status: 'open',
        },
        {
          name: 'Mohan Panda',
          age: 65,
          gender: 'male',
          lastSeenLocation: 'Near Daya river bridge',
          clothes: 'White shirt, brown trousers',
          contactPhone: '+91-9000000302',
          status: 'open',
        },
        {
          name: 'Priyanka Das',
          age: 27,
          gender: 'female',
          lastSeenLocation: 'Janata Maidan shelter',
          clothes: 'Blue saree',
          contactPhone: '+91-9000000303',
          status: 'matched',
        },
      ],
    });
    console.log('Seeded 3 missing persons');
  }
