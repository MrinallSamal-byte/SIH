...
3. **ESA Copernicus Sentinel-1 SAR & UN-SPIDER**: [Copernicus](https://dataspace.copernicus.eu/) & [UN-SPIDER](https://www.un-spider.org/advisory-support/recommended-practices/recommended-practice-flood-mapping) — All-weather synthetic aperture radar satellite flood extent segmentation and Otsu thresholding (processed via AI engine, excluded from Node.js core backend).
